...
* The original package name 'pe.edu.upc.inscription.turisteando-platform' is invalid and this project uses 'pe.edu.upc.inscription.turisteando_platform' instead.
